...
<body class="bg-gray-200 dark:bg-gray-600 min-h-screen antialiased">
 <div id="main" class="main" v-cloak>
   ...
   <a class="@if (request()->routeIs('post.create')) hidden @endif" href="{{ route('post.create') }}">
     <div
     class="bg-blue-900 hover:bg-blue-800 h-12 w-12 rounded-full fixed z-50 bottom-10 right-7 grid place-items-center lg:hidden">
 ...
 <main class="font-sans antialiased mx-auto my-10 flex gap-x-10 px-2 sm:px-4 md:px-6 lg:px-0 max-w-7xl">
   <div class="w-3/12 hidden md:block">
     <nav class="flex flex-col dark:text-gray-200">
       ...
       <a href="{{ route('post.index') }}" class="mb-3">
         <div
         class="py-2 inline-flex w-full border-l-4 border-transparent rounded
         @if (request()->routeIs('post.index')) bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 @endif">
         <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 ml-5" fill="none"
   ...
   <a href="{{ route('user.posts') }}" class="mb-3">
     <div
     class="py-2 inline-flex w-full border-l-4 border-transparent rounded @if (request()->routeIs('user.posts')) bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 @endif">
     <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 ml-5" fill="none"
     viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
     <path stroke-linecap="round" stroke-linejoin="round"
...
<a href="{{ route('my-comments') }}" class="mb-3">
 <div
 class="py-2 inline-flex w-full border-l-4 border-transparent rounded @if (request()->routeIs('my-comments')) ) bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 @endif">
 <svg class="w-6 h-6 mr-2 ml-5" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6"
...
<a href="{{ route('category.index') }}" class="mb-3">
 <div
 class="py-2 inline-flex w-full border-l-4 border-transparent rounded @if (request()->routeIs('category.index')) bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 @endif">
 <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 ml-5" fill="none"
 viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
 <path stroke-linecap="round" stroke-linejoin="round"
...
<a href="{{ route('admin.home') }}" class="mb-3">
 <div
 class="py-2 inline-flex w-full border-l-4 border-transparent rounded @if (request()->routeIs('admin.home')) bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 @endif">
...
<a href="{{ route('users') }}" class="mb-1">
 <div
 class="py-2 inline-flex w-full border-l-4 border-transparent rounded @if (request()->routeIs('users')) bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 @endif">
 <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 ml-5" fill="none"
 viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
 <path stroke-linecap="round" stroke-linejoin="round"
...
<a href="{{ route('setting.index') }}" class="mb-1">
 <div
 class="py-2 inline-flex w-full border-l-4 border-transparent rounded @if (request()->routeIs('setting.index')) bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 @endif">
 <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 mr-2 ml-5" fill="none"
 viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
 <path stroke-linecap="round" stroke-linejoin="round"
...
<div class="mt-10 lg:hidden">
 ...
 <div class="grid gap-y-2 mb-20 shadow-lg rounded-md p-3 bg-gray-100 dark:bg-gray-400">
   @foreach (\App\Models\User::withCount('posts')->orderBy('posts_count', 'desc')->take(5)->get()
   as $user)
   <div class="grid grid-cols-8">
     <img @if ($user->profile->file) src="/uploads/{{ $user->profile->file->file }}" 
     ...
     <span class="text-blue-900 font-semibold text-xs col-span-5"><a
       ...
       <span>
         <svg class="fill-current text-gray-400 dark:text-gray-800 text-blue-900 w-4 h-6"
...
<div class="w-3/12 hidden lg:block pr-6 xl:pr-0">
 ...
 <a href="{{ route('post.create') }}">
   <div
   class="pt-1 pb-2 px-1 bg-blue-900 text-gray-100 font-semibold mb-3 hover:bg-blue-800 mt-4 text-center rounded-md">
...
<div class="mt-10">
 ...
 <div
 class="flex justify-between text-xs font-semibold text-gray-500 dark:text-gray-800 p-4 bg-gray-100 dark:bg-gray-400 shadow rounded-md">
