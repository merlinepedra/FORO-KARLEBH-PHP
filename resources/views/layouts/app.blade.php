  ...
  <div id="main" v-cloak class="bg-gray-200 dark:bg-gray-600">
    ...
    <main class="font-sans antialiased mx-auto my-10 flex gap-x-10 md:px-6 lg:px-0 max-w-7xl">
      <div class="w-3/12 hidden md:block">
       <nav class="flex flex-col dark:text-gray-200">
        ...
        <a href="{{ route('post.index') }}" class="mb-3">
          <div class="py-2 inline-flex w-full border-l-4 border-transparent @if(request()->routeIs('post.index')) bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 @endif">
        ...
        <a href="{{ route('user.posts') }}" class="mb-3">
          <div class="py-2 inline-flex w-full border-l-4 border-transparent @if(request()->routeIs('user.posts')) bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 @endif">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 ml-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('my-comments') }}" class="mb-3">
          <div class="py-2 inline-flex w-full border-l-4 border-transparent @if(request()->routeIs('my-comments'))) bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 @endif">
      ...
      <a href="{{ route('category.index') }}" class="mb-3">
        <div class="py-2 inline-flex w-full border-l-4 border-transparent @if(request()->routeIs('category.index')) bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 @endif">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 ml-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <a href="{{ route('admin.home') }}" class="mb-3">
        <div class="py-2 inline-flex w-full border-l-4 border-transparent @if(request()->routeIs('admin.home')) bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 @endif">
      ...
      <a href="{{ route('users') }}" class="mb-1">
        <div class="py-2 inline-flex w-full border-l-4 border-transparent @if(request()->routeIs('users')) bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 @endif">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 ml-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <a href="{{ route('setting.index') }}" class="mb-1">
        <div class="py-2 inline-flex w-full border-l-4 border-transparent @if(request()->routeIs('setting.index')) bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 @endif">
