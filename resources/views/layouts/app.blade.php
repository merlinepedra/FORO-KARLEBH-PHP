...
<body>
  <div id="main" v-cloak class="bg-gray-200">
    <header class="p-6 bg-gray-50 shadow-sm dark:bg-gray-700 dark:text-gray-100">
      <div class="max-w-6xl font-semibold flex flex-col md:flex-row md:items-center">
        ...
        <div class="flex justify-between">
          ...
          <main class="font-sans antialiased mx-auto my-10">
            @yield('section')
          </main>
        </div>
        <script>
