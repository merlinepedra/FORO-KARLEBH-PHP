        ...
        <div class="relative flex-shrink-0">
          ...
          <transition name="flip">
            <div v-if="profileMenu" id="profile-menu" class="text-black absolute right-0 bg-lime-300 py-4 mt-5 z-10 w-48 text-center">
              <a v-on:click="profileMenu = false" class="block mt-3 hover:bg-lime-400 px-2 py-2" href="{{ route('profile.edit', auth()->id()) }}">Edit Profile</a>
              <a v-on:click="profileMenu = false" class="block mt-3 hover:bg-lime-400 px-2 py-2" href="{{ route('profile.show', auth()->id()) }}">View Profile</a>
