...
<div class="w-full mt-5 mx-auto bg-gray-100 p-6 rounded-md dark:bg-gray-700 dark:text-gray-300">
  ...
  <div class="md:w-9/12 mx-auto mt-10">
    ...
    class="w-full rounded-md resize-none h-40 focus:ring-0 focus:border-purple-500 placeholder-gray-800 dark:placeholder-gray-300 dark:bg-gray-600">{{ $comment->comment }}</textarea>
    @error('comment')
  ...
  <div class="mt-8 md:w-9/12 mx-auto">
    <input type="submit" value="Update Comment" class="px-3 py-2 bg-gray-700 dark:bg-gray-800 text-gray-100 dark:text-gray-200 rounded-md focus:ring-0 focus:border-purple-500 font-semibold">
  </div>
