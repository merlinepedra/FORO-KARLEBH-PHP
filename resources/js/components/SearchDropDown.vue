<template>
    <div class="relative">
        <div class="md:hidden relative">
            ...
            <div
                class="absolute z-10 rounded-md shadow-md mt-3 w-full bg-gray-200"
        ...
        <div class="hidden md:block relative z-30">
            ...
            <button
                ...
                "
                @click="closeOverlay"
                class="bg-transparent inset-0 w-full h-full fixed"
                style="z-index: 30"
            ></button>
            ...
            <div
                class="absolute z-10 rounded-md overflow-hidden shadow-md mt-3 w-full bg-gray-200 dark:bg-gray-400 dark:text-gray-800"
