...
<div class="mx-auto w-full bg-gray-100 p-6 mt-6 rounded-md dark:bg-gray-700">
  <div>
    ...
    <div id="<?php echo e($notification->id); ?>" class="bg-blue-200 dark:bg-gray-500 min-h-40 rounded-md shadow mb-3 p-4 text-gray-700 flex justify-between">
      <div>
        <a href="<?php echo e(route('profile.show', $notification->data['liker']['name'])); ?>" class="capitalize font-semibold text-blue-400 dark:text-gray-200"><?php echo e(str_replace('-', ' ',  $notification->data['liker']['name'])); ?></a>
    ...
    <div id="<?php echo e($notification->id); ?>" class="bg-blue-200 dark:bg-gray-400 min-h-40 rounded-md shadow mb-3 p-4 flex justify-between">
      <div>
        <a href="<?php echo e(route('profile.show', $notification->data['follower']['name'])); ?>" class="capitalize font-semibold text-blue-400 dark:text-gray-200"><?php echo e(str_replace('-', ' ',  $notification->data['follower']['name'])); ?></a>
    ...
    <div id="<?php echo e($notification->id); ?>" class="bg-blue-200 dark:bg-gray-400 min-h-40 rounded-md shadow mb-3 p-4 flex justify-between">
      <div>
        <a href="<?php echo e(route('profile.show', $notification->data['sender']['name'])); ?>" class="capitalize font-semibold text-blue-400 dark:text-gray-200"><?php echo e(str_replace('-', ' ',  $notification->data['sender']['name'])); ?></a>
