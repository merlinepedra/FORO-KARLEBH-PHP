  <div class="md:hidden">
    <div class="flex justify-between">
      ...
      <div class="flex items-center">
        ...
        <div>
          <a href="<?php echo e(route('login')); ?>" class="text-gray-700 mr-4 dark:text-gray-300">login</a>
        </div>
        <?php endif; ?>
        ...
        <nav v-if="mobileNav" class="flex flex-col text-gray-600 dark:text-gray-200">
          ...
          <a href="<?php echo e(route('post.index')); ?>" class="mb-1 text-sm">
            <div class="py-1 inline-flex items-center w-full border-l-4 border-transparent <?php if(request()->routeIs('post.index')): ?> dark:text-gray-500 bg-blue-100 border-blue-900 <?php endif; ?>">
        ...
        <a href="<?php echo e(route('user.posts')); ?>" class="mb-1 text-sm">
          <div class="py-1 inline-flex items-center w-full border-l-4 border-transparent <?php if(request()->routeIs('user.posts')): ?> dark:text-gray-500 bg-blue-100 border-blue-900 <?php endif; ?>">
           <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 ml-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <a href="<?php echo e(route('my-comments')); ?>" class="mb-1 text-sm">
        <div class="py-2 inline-flex items-center w-full border-l-4 border-transparent <?php if(request()->routeIs('my-comments')): ?> dark:text-gray-500 bg-blue-100 border-blue-900 <?php endif; ?>">
      ...
      <a href="<?php echo e(route('category.index')); ?>" class="mb-1 text-sm">
        <div class="py-2 inline-flex items-center w-full border-l-4 border-transparent <?php if(request()->routeIs('category.index')): ?> dark:text-gray-500 bg-blue-100 border-blue-900 <?php endif; ?>">
         <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 ml-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <a href="<?php echo e(route('admin.home')); ?>" class="mb-1 text-sm">
      <div class="py-2 inline-flex items-center w-full border-l-4 border-transparent <?php if(request()->routeIs('admin.home')): ?> dark:text-gray-500 bg-blue-100 border-blue-900 <?php endif; ?>">
  ...
  <a href="<?php echo e(route('setting.index')); ?>" class="mb-1">
    <div class="py-2 inline-flex w-full border-l-4 border-transparent <?php if(request()->routeIs('setting.index')): ?> dark:text-gray-500 bg-blue-100 border-blue-900 <?php endif; ?>">
 ...
 <a href="<?php echo e(route('users')); ?>" class="mb-1 text-sm">
  <div class="py-2 inline-flex w-full border-l-4 border-transparent <?php if(request()->routeIs('users')): ?> dark:text-gray-500 bg-blue-100 border-blue-900 <?php endif; ?>">
   <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 ml-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
<div class="">
  <div class="flex items-center">
    ...
    src="/storage/uploads/<?php echo e(auth()->user()->profile->file->file); ?>" 
