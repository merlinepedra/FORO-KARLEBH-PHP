...
<div class="">
  ...
  <div  class="text-sm italic py-2">
    <a class="block mt-1 hover:bg-blue-100 px-2 py-1" href="<?php echo e(route('profile.edit', auth()->user()->profile->name)); ?>">Edit Profile</a>
    <a class="block mt-1 hover:bg-blue-100 px-2 py-1" href="<?php echo e(route('profile.show', auth()->user()->profile->name)); ?>">
      View Profile
    </a>
