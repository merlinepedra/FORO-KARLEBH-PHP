  <div class="md:hidden">
    <div class="flex justify-between items-center">
      ...
      <nav v-if="mobileNav" class="flex flex-col text-gray-600 dark:text-gray-200">
        ...
        <a href="<?php echo e(route('post.index')); ?>" class="mb-1 text-sm">
          <div class="py-1 inline-flex items-center w-full border-l-4 border-transparent <?php if(request()->routeIs('post.index')): ?> 
           bg-blue-100 dark:text-gray-700 dark:bg-gray-400 border-blue-900 rounded <?php endif; ?>">
      ...
      <a href="<?php echo e(route('user.posts')); ?>" class="mb-1 text-sm">
        <div class="py-1 inline-flex items-center w-full border-l-4 border-transparent <?php if(request()->routeIs('user.posts')): ?> 
          dark:text-gray-700 dark:bg-gray-400 rounded bg-blue-100 border-blue-900 <?php endif; ?>">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 ml-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <a href="<?php echo e(route('my-comments')); ?>" class="mb-1 text-sm">
        <div class="py-2 inline-flex items-center w-full border-l-4 border-transparent <?php if(request()->routeIs('my-comments')): ?> dark:text-gray-700 dark:bg-gray-400 rounded bg-blue-100 border-blue-900 <?php endif; ?>">
      ...
      <a href="<?php echo e(route('category.index')); ?>" class="mb-1 text-sm">
        <div class="py-2 inline-flex items-center w-full border-l-4 border-transparent <?php if(request()->routeIs('category.index')): ?> dark:text-gray-700 dark:bg-gray-400 rounded bg-blue-100 border-blue-900 <?php endif; ?>">
         <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 ml-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <a href="<?php echo e(route('admin.home')); ?>" class="mb-1 text-sm">
      <div class="py-2 inline-flex items-center w-full border-l-4 border-transparent <?php if(request()->routeIs('admin.home')): ?> dark:text-gray-700 dark:bg-gray-400 rounded bg-blue-100 border-blue-900 <?php endif; ?>">
  ...
  <a href="<?php echo e(route('setting.index')); ?>" class="mb-1">
    <div class="py-2 inline-flex w-full border-l-4 border-transparent <?php if(request()->routeIs('setting.index')): ?> dark:text-gray-700 dark:bg-gray-400 rounded bg-blue-100 border-blue-900 <?php endif; ?>">
 ...
 <a href="<?php echo e(route('users')); ?>" class="mb-1 text-sm">
  <div class="py-2 inline-flex w-full border-l-4 border-transparent <?php if(request()->routeIs('users')): ?> dark:text-gray-700 dark:bg-gray-400 rounded bg-blue-100 border-blue-900 <?php endif; ?>">
   <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 ml-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
<div class="">
  ...
  <div  class="text-sm italic py-2">
    <a class="block mt-1 hover:bg-blue-100 dark:hover:bg-gray-500 px-2 py-1" href="<?php echo e(route('profile.edit', auth()->user()->profile->name)); ?>">Edit Profile</a>
    <a class="block mt-1 hover:bg-blue-100 dark:hover:bg-gray-500 px-2 py-1" href="<?php echo e(route('profile.show', auth()->user()->profile->name)); ?>">
      View Profile
    </a>
