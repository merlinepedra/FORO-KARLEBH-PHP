...
<?php endif; ?>
 ...
 <main class="font-sans antialiased mx-auto my-10 flex gap-x-10 px-2 sm:px-4 md:px-6 lg:px-0 max-w-7xl">
   ...
   <a href="<?php echo e(route('user.posts')); ?>" class="mb-3">
     <div
     class="py-2 inline-flex w-full border-l-4 border-transparent rounded <?php if(request()->routeIs('user.posts')): ?> bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 <?php endif; ?>">
     <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 ml-5" fill="none"
     viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
     <path stroke-linecap="round" stroke-linejoin="round"
...
<a href="<?php echo e(route('my-comments')); ?>" class="mb-3">
 <div
 class="py-2 inline-flex w-full border-l-4 border-transparent rounded <?php if(request()->routeIs('my-comments')): ?> ) bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 <?php endif; ?>">
...
<a href="<?php echo e(route('category.index')); ?>" class="mb-3">
 <div
 class="py-2 inline-flex w-full border-l-4 border-transparent rounded <?php if(request()->routeIs('category.index')): ?> bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 <?php endif; ?>">
 <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 ml-5" fill="none"
 viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
 <path stroke-linecap="round" stroke-linejoin="round"
...
<a href="<?php echo e(route('admin.home')); ?>" class="mb-3">
 <div
 class="py-2 inline-flex w-full border-l-4 border-transparent rounded <?php if(request()->routeIs('admin.home')): ?> bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 <?php endif; ?>">
...
<a href="<?php echo e(route('users')); ?>" class="mb-1">
 <div
 class="py-2 inline-flex w-full border-l-4 border-transparent rounded <?php if(request()->routeIs('users')): ?> bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 <?php endif; ?>">
 <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 ml-5" fill="none"
 viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
 <path stroke-linecap="round" stroke-linejoin="round"
...
<a href="<?php echo e(route('setting.index')); ?>" class="mb-1">
 <div
 class="py-2 inline-flex w-full border-l-4 border-transparent rounded <?php if(request()->routeIs('setting.index')): ?> bg-blue-100 dark:text-gray-900 dark:bg-gray-400 border-blue-900 <?php endif; ?>">
 <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 mr-2 ml-5" fill="none"
 viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
 <path stroke-linecap="round" stroke-linejoin="round"
