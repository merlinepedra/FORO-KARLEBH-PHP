<div class="hidden md:block desktop-header">
  ...
  <div class="flex justify-between items-center">
   ...
   <div class="flex items-center">
    ...
    <dark-light-mode class="mr-8 mt-1"></dark-light-mode>
    ...
    <span class="mr-8 relative">
      <a href="<?php echo e(route('notifications')); ?>">
        <svg viewBox="0 0 24 24" aria-hidden="true" class="fill-current w-6 h-6 relative">
          ...
          <span 
          class="text-blue-100 bg-blue-900 dark:text-blue-900 dark:bg-gray-50 font-extrabold text-[.55rem] absolute -top-1 -right-1 py-[.5] px-1 rounded-full">
      ...
      <div class="relative flex-shrink-0">
        ...
        <transition name="flip">
          <div v-if="profileMenu" class="font-light absolute right-0 bg-blue-900 text-blue-100 pt-4 mt-5 z-20 w-48 text-center shadow-md rounded-md">
            <a v-on:click="profileMenu = false" class="block mt-3 overflow-hidden hover:overflow-hidden hover:bg-blue-100 hover:text-gray-900 px-2 py-2" href="<?php echo e(route('profile.edit', auth()->user()->profile->name)); ?>">Edit Profile</a>
            <a v-on:click="profileMenu = false" class="block mt-3 overflow-hidden hover:overflow-hidden hover:bg-blue-100 hover:text-gray-900 px-2 py-2" href="<?php echo e(route('profile.show', auth()->user()->profile->name)); ?>">
