  ...
  <div class="mx-auto w-full bg-gray-50 md:rounded-md p-6">
    <div>
      <div>
        ...
        <div class="grid grid-cols-2 gap-3 place-items-center">
          ...
          <img class="object-cover object-center" src="/storage/uploads/<?php echo e($file->file); ?>">
    ...
    <div>
      ...
      <div class="inline-flex">
        ...
        <a href="<?php echo e(route('post.edit', $post)); ?>" class="text-gray-800 font-semibold textlg md:text-2xl">Edit</a>
        <?php endif; ?>
      </div>
...
unset($__errorArgs, $__bag); ?>
    ...
    <section class="mt-10">
      ...
      <div class="border-2 rounded-md p-6 mb-4">
        ...
        <div class="grid <?php if($comment->files->count() > 1): ?> grid-cols-2 gap-3 <?php endif; ?> place-items-center truncate overflow-auto">
        ...
        <div>
          <div class="mt-5 inline-flex">
            ...
            <button data-parent-id="<?php echo e($comment->id); ?>" v-on:click="openReplyBox" id="replyBtn" class="text-gray-800 font-semibold text-2xl mr-10">
            Reply</button>
            <?php endif; ?>

            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $comment)): ?>
            <a href="<?php echo e(route('comment.edit', $comment)); ?>" class="text-gray-800 font-semibold text-2xl">Edit</a>
            <?php endif; ?>
          </div>


          <div class="hidden mt-4 replyBox">
            <form action="<?php echo e(route('comment.reply')); ?>" method="POST">
        ...
        <div class="border-2 rounded-md p-6 mt-6">
          ...
          <div class="inline-flex">
            ...
            <a href="<?php echo e(route('comment.edit', $reply)); ?>" class="text-gray-800 font-semibold text-2xl">Edit</a>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Jet\resources\views/post/show.blade.php ENDPATH**/ ?>