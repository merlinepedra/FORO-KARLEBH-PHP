  ...
  <div class="mx-auto w-full bg-gray-50 rounded-md p-6 dark:bg-gray-400 dark:text-gray-700">
    <div>
      <div>
        ...
        <div class="grid grid-cols-2 gap-x-5 place-items-center my-10">
          ...
          src="/uploads/<?php echo e($file->file_url); ?>">
          <?php else: ?>
          <img class="object-cover object-center shadow-md rounded-md"
          src="/uploads/<?php echo e($file->file); ?>">
          <?php endif; ?>
    ...
    <div>
      ...
      <div class="flex items-center mt-2">
        ...
        <Like :likeable_id="<?php echo e($post->id); ?>" likeable_type="<?php echo e($post::class); ?>"
          :user_id="<?php echo e($post->user_id); ?>" class="mr-10"></Like>
      ...
      <div>
        <div class="mt-5 flex items-center">
          <Like :likeable_id="<?php echo e($comment->id); ?>" likeable_type="<?php echo e($comment::class); ?>"
            ...
            <div class="flex mr-10">
              <a href="<?php echo e(route('reply.create', $comment)); ?>" data-parent-id="<?php echo e($comment->id); ?>"
            ...
            <div class="flex mr-8">
              <a href="<?php echo e(route('comment.edit', $comment)); ?>"
        ...
        <div class="border-2 rounded-md p-6 mt-6">
          <div class="">
            ...
            <div
            class="grid <?php if($reply->files->count() > 1): ?> grid-cols-2 gap-3 <?php endif; ?> place-items-center truncate overflow-auto">
            ...
            src="/uploads/<?php echo e($item->file); ?>">
            <?php else: ?>
            <p>
        ...
        <div class="inline-flex">
          <Like :likeable_id="<?php echo e($reply->id); ?>" likeable_type="<?php echo e($reply::class); ?>"
            :user_id="<?php echo e($reply->user_id); ?>" class="mr-10"></Like>

            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $reply)): ?>
            <div class="flex">
              <a href="<?php echo e(route('comment.edit', $reply)); ?>"
              class="text-gray-800 font-semibold text-2xl">
