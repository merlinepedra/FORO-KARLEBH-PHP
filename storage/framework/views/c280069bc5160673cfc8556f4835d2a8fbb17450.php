...
<div class="mx-auto w-full bg-gray-100 md:rounded-md p-6 mt-5 dark:bg-gray-500 dark:text-gray-400">
  <form action="<?php echo e(route('profile.update', $profile)); ?>" method="POST" enctype="multipart/form-data" class="py-3" enctype="multipart/form-data">
    ...
    <div class="mt-7 md:w-9/12 mx-auto">
      ...
      class="placeholder-gray-800 dark:placeholder-gray-300 dark:bg-gray-400 dark:text-gray-300 mt-3 w-full rounded-md focus:ring-0 focus:border-purple-500 <?php if($profile->city): ?> bg-gray-300 <?php endif; ?>" 
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mt-10 md:w-9/12 mx-auto">
      ...
      name="country" placeholder="What country are you from?" class="placeholder-gray-800 dark:placeholder-gray-300 dark:bg-gray-400 dark:text-gray-300 mt-3 w-full rounded-md focus:ring-0 focus:border-purple-500 <?php if($profile->country): ?> bg-gray-300 <?php endif; ?>" 
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mt-10 md:w-9/12 mx-auto">
      ...
      <input type="text" autocomplete="off"
      name="phone" placeholder="We do not mind if you share your phone number" class="placeholder-gray-800 dark:placeholder-gray-300 dark:bg-gray-400 dark:text-gray-300 mt-3 w-full rounded-md focus:ring-0 focus:border-purple-500 <?php if($profile->phone): ?> bg-gray-300 <?php endif; ?>" 
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="md:w-9/12 mx-auto mt-10">
      ...
      <select name="sex" class="placeholder-gray-800 dark:placeholder-gray-300 dark:bg-gray-400 dark:text-gray-300 w-full rounded-md focus:ring-0 focus:border-purple-500 mt-2 <?php if($profile->sex): ?> bg-gray-300 <?php endif; ?>">
