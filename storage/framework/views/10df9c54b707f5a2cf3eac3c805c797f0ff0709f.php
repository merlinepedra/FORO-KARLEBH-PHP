  <div class="md:hidden">
    <div class="flex justify-between">
      ...
      <div class="flex items-center">
        ...
        <a href="<?php echo e(route('login')); ?>" class="text-gray-700 mr-6">Login</a>
        <?php endif; ?>
        
        <button v-on:click="searchBoxOpen = !searchBoxOpen">
          <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-current mr-6"><g><path d="M21.53 20.47l-3.66-3.66C19.195 15.24 20 13.214 20 11c0-4.97-4.03-9-9-9s-9 4.03-9 9 4.03 9 9 9c2.215 0 4.24-.804 5.808-2.13l3.66 3.66c.147.146.34.22.53.22s.385-.073.53-.22c.295-.293.295-.767.002-1.06zM3.5 11c0-4.135 3.365-7.5 7.5-7.5s7.5 3.365 7.5 7.5-3.365 7.5-7.5 7.5-7.5-3.365-7.5-7.5z"></path></g></svg>
        </button>

        <?php if(auth()->guard()->check()): ?>
        <a href="<?php echo e(route('notifications')); ?>">
          <span class="relative">
            <svg viewBox="0 0 24 24" aria-hidden="true" class="fill-current w-6 h-6 mr-6 relative">
      ...
      <nav v-if="mobileNav" class="flex flex-col text-gray-600">
        ...
        <a href="<?php echo e(route('post.index')); ?>" class="mb-1 hover:bg-gray-200 text-sm">
          <div class="py-1 inline-flex items-center w-full border-l-4 border-transparent <?php if(request()->routeIs('post.index')): ?> bg-blue-100 border-blue-900 <?php endif; ?>">
        ...
        <a href="#" class="mb-1 hover:bg-gray-200 text-sm">
          <div class="py-1 inline-flex items-center w-full border-l-4 border-transparent <?php if(false): ?> bg-blue-100 border-blue-900 <?php endif; ?>">
        ...
        <a href="#" class="mb-1 hover:bg-gray-200 text-sm">
          <div class="py-2 inline-flex items-center w-full border-l-4 border-transparent <?php if(false): ?> bg-blue-100 border-blue-900 <?php endif; ?>">
        ...
        <a href="<?php echo e(route('category.index')); ?>" class="mb-1 hover:bg-gray-200 text-sm">
          <div class="py-2 inline-flex items-center w-full border-l-4 border-transparent <?php if(request()->routeIs('category.index')): ?> bg-blue-100 border-blue-900 <?php endif; ?>">
        ...
        <a href="<?php echo e(route('admin.home')); ?>" class="mb-1 hover:bg-gray-200 text-sm">
          <div class="py-2 inline-flex items-center w-full border-l-4 border-transparent <?php if(request()->routeIs('admin.home')): ?> bg-blue-100 border-blue-900 <?php endif; ?>">
            <svg class="w-6 h-6 mr-2 ml-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M20 2H4c-1.103 0-2 .897-2 2v12c0 1.103.897 2 2 2h3v3.767L13.277 18H20c1.103 0 2-.897 2-2V4c0-1.103-.897-2-2-2zm0 14h-7.277L9 18.233V16H4V4h16v12z"/></svg>
            Admin
          </div>
        </a>
