...
<div class="mx-auto w-full bg-gray-100 rounded-md p-6 mt-5 text-gray-800 dark:bg-gray-700 dark:text-gray-200">
  ...
  <div class="grid place-items-center sm:grid-cols-2">
    <div>
      <img class="h-28 md:h-40 rounded-md" <?php if($latestPic): ?> src="/uploads/<?php echo e($latestPic); ?>" <?php else: ?> src="/image-header.jpg" <?php endif; ?>>
    </div>
  ...
  <div class="flex justify-center my-6">
    <Follow :user_id="<?php echo e($profile->user->id); ?>" :follows="<?php echo e(auth()->user() ? (int) auth()->user()->following->contains($profile->user->id) : 0); ?>"></Follow>
  </div>
  <?php endif; ?>
  ...
  <div class="mt-5 dark:bg-gray-500 p-5 rounded-md">
    ...
    <div class="flex flex-col border-b border-dashed border-blue-200 pb-4 mt-3">
      ...
      <span class="text-gray-800 dark:text-gray-200"><?php echo e($profile->user->email); ?></span>
    </div>

    <?php if($profile->city): ?>
    <div class="flex flex-col border-b border-dashed border-blue-200 pb-4 mt-3">
      <span class="text-sm text-gray-500 dark:text-gray-300">City</span>
      <span class="text-gray-800 dark:text-gray-200"><?php echo e($profile->user->city); ?></span>
    </div>
    <?php endif; ?>
    ...
    <div class="flex flex-col border-b border-dashed border-blue-200 pb-4 mt-3">
      ...
      <span class="text-gray-800 dark:text-gray-200"><?php echo e($profile->phone); ?></span>
    </div>
    <?php endif; ?>
    ...
    <div class="flex flex-col border-b border-dashed border-blue-200 pb-4 mt-3">
      ...
      <span class="text-gray-800 dark:text-gray-200"><?php echo e($profile->country); ?></span>
    </div>
    <?php endif; ?>
    ...
    <div class="flex flex-col border-b border-dashed border-blue-200 pb-4 mt-3">
      ...
      <span class="text-gray-800 dark:text-gray-200"><?php echo e(ucfirst($profile->sex)); ?></span>
    </div>
    <?php endif; ?>
